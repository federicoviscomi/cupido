...
public class WaitingDealAsPlayer {
	...
	public WaitingDealAsPlayer(final CardsGameWidget cardsGameWidget, final StateManager stateManager, final List<Card> hand) {
		...
		StateManager.PlayerInfo playerInfo = stateManager.getPlayerInfo().get(currentPlayer);
